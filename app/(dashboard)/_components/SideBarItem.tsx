...
const SideBarItem = ({ icon: Icon, label, href }: Props) => {
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center gap-x-2 mx-4 mb-2 rounded-lg text-muted-foreground text-sm font-[500] pl-9 transition-all hover:text-foreground/75 hover:bg-foreground/10",
        isActive &&
